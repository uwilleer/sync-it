...
async def send_faq_message(message: Message, *, need_reply_markup: bool = True) -> None:
    await message.answer(
        ...
        "Просто напишите название навыка в ответ на сообщение с вакансией и он добавится в ваш профиль!\n"
        "<i>Если напишете навык, который уже есть в профиле — он удалится</i>\n\n\n"
