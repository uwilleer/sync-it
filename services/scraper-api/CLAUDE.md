...
- Telethon сессия хранится в base64 (`SCRAPER_API_TELETHON_SESSION_BASE64`), при старте декодируется в `.session` файл
...
```
SCRAPER_API_TELETHON_SESSION_BASE64=...  # base64 от .session файла
SCRAPER_API_TELETHON_SESSION_NAME=...    # имя файла сессии (без .session)
